            ...
            <article class="bg-white col-12">
                ...
                <div class="row">
                    ...
                    <div class="col text-center">
                        <a class="btn yellow-btn-304-50" href="{{url('profile/manage/payment/update').'/1'}}" id="cardBtn">クレジット決済を押す</a>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:32px">
                    <fieldset style="width:220px;height:130px;text-align:center;border:1px dashed #707070;margin-right:24px">
                        <legend style="width:40%">
                            <a id="car1" href="{{url('profile/manage/payment/update').'/2'}}"><img src="/images/svg/img-payment-au-btn.svg"></a>
                        </legend>
                        <p class="title-12px">auかんたん決済</p>
                    </fieldset>
                    <fieldset style="width:220px;height:130px;text-align:center;border:1px dashed #707070;margin-right:24px">
                        <legend style="width:40%">
                            <a id="car2" href="{{url('profile/manage/payment/update').'/3'}}"><img src="/images/svg/img-payment-docomo-btn.svg"></a>
                        </legend>
                        <p class="title-12px">ドコモ払い</p>
                    </fieldset>
                    <fieldset style="width:220px;height:130px;text-align:center;border:1px dashed #707070;margin-right:24px">
                        <legend style="width:40%">
                            <a id="car3" href="{{url('profile/manage/payment/update').'/4'}}"><img src="/images/svg/img-payment-softbank-btn.svg"></a>
                        </legend>
