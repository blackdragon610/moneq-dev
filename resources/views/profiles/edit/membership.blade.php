    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom:80px">
            <div class="col-md-12 col-lg-12 bg-white">
                <p class="title-medium">会員ステータス</p>
                <!-- <hr class="mt-2 mb-3"/> -->
                <!-- <p>現在のプランは月払会員</p> -->

                <div class="row">
                    <div class="col-sm-12 col-md-6 pl-0 pr-0 pr-md-2">
                        <article class="col-12" style="background-color:#FFF9F2; max-width:488px; max-height:402px">
                    ...
                    <div class="col-sm-12 col-md-6 pl-0 pr-0 pl-md-2 mt-4 mt-md-0">
                        <article class="col-12" style="background-color:#F5F5F5; max-width:488px; max-height:402px">
