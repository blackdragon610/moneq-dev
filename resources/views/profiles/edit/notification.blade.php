                ...
                <div class="container" style="padding-left:70px;padding-right:70px">
                    <div class="col-7">
                        <div class="row">
                            <label class="cl-switch cl-switch-red">
                                ...
                                <input type="checkbox" <?php if(/*$user->is_send_answer == 1*/true) echo 'checked'?> name="is_send_answer"/>
                        ...
                        <div class="row">
                            <label class="cl-switch cl-switch-red">
                                ...
                                <input type="checkbox" <?php if(/*$user->is_send_message == 1*/true) echo 'checked'?> name="is_send_message"/>
                                <span class="switcher"></span>
                            </label>
                        ...
                        <div class="row">
                            <label class="cl-switch cl-switch-red">
                                ...
                                <input type="checkbox" <?php if(/*$user->is_send_master == 1*/false) echo 'checked'?> name="is_send_master"/>
                                <span class="switcher"></span>
                            </label>
                        </div>                        
                    </div>
                    <div class="col-5" style="width:300px">
                        ...
                        <div class="row" style="margin-top:12px">
                            <button class="btnUnselected" style="width:300px">会員情報に戻る</button>
                        </div>                        
                    </div>
                </div>
            </div>
