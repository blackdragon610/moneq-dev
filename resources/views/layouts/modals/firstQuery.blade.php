        ...
        <div class="modal-content">
            ...
            <form id="place_form" class="form" style="padding:24px" name="place" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body" style="padding: 0px;">
                    ...
                    <p class="label-16px" style="padding-left:12px">３．回答に対する追加の返信も可能（一つの回答に対して最大3回まで）</p>

                    <p class="title-16px" style="background-color:#FFF5E9;padding-left:12px;margin-top:32px">相談時の注意事項</p>

                    <p class="label-16px" style="padding-left:12px">・具体的に（数字や年数など）相談内容を記入すると回答が得やすくなります。</p>
                    <p class="label-16px" style="padding-left:12px">・相談の状況（年齢、年収、家族構成など）を詳細に記入すると回答が得やすくなります。</p>
                    <p class="label-16px" style="padding-left:12px">・個人情報は記入しないように注意してください。</p>
                    <p class="label-16px" style="padding-left:12px">・特定の企業、商品、サービスに関する記載はしないように注意してください。</p>

                </div>
                <div class="pb-3" style="text-align:center;margin-top:36px">
                    <button class="btnSubmit modal-btn-304-50" id="fBtn" value="add">相談内容を入力する</button>
                </div>
            </form>
        </div>
    </div>
